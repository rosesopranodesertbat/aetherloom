...
pub enum ValidationError {
    ...
    ZeroCommandSequence,
    MoveAxisOutOfRange { axis: &'static str, value: i16 },
    ...
    CommandTickMismatch { expected: u64, actual: u64 },
    DuplicatePlayer(u16),
    ...
    DuplicateEntity(u64),
    DuplicateEvent(u64),
    DuplicateChunk { x: i32, y: i32 },
    DuplicateTerrainCell { x: u16, y: u16 },
    ...
    InvalidTerrainCell { x: u16, y: u16 },
    InvalidTerrainCellCount { count: usize, expected: usize },
    InvalidTerrainRevision { base: u32, new: u32 },
